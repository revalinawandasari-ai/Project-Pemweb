...
<main class="relative flex flex-col w-full max-w-[1280px] px-[75px] mx-auto mt-[50px] mb-[62px]">
    ...
    <div class="flex gap-[30px] mt-[30px]">
                    ...
                    <div class="flex flex-col rounded-[20px] border border-[#E8EFF7] p-5 gap-5">
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <p class="font-semibold text-garuda-green text-center">{{ 'Rp. ' . number_format($transaction->class->price, 0, ',', '.') }}</p>
                            </div>
            ...
            <div id="Transaction-Info" class="accordion group flex flex-col h-fit rounded-[20px] bg-white overflow-hidden has-[:checked]:!h-[75px] transition-all duration-300">
                ...
                <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                    <div class="flex justify-between">
                        <div>
                            <p class="text-sm text-garuda-grey">Quantity</p>
                            <p class="font-semibold text-lg leading-[27px] mt-[2px]">{{ $transaction->number_of_passengers }} People</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-lg leading-[27px] mt-[2px]">
                                @foreach ($transaction->passengers as $passenger)
                                    {{ $passenger->seat->name }}@if (!$loop->last), @endif
                                @endforeach
                            </p>
                        </div>
                    </div>
                    <div class="flex justify-between">
                        <div>
                            ...
                            <p class="font-semibold text-lg leading-[27px] mt-[2px]">{{ 'Rp. ' . number_format($transaction->class->price, 0, ',', '.') }}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-lg leading-[27px] mt-[2px]">{{ 'Rp. ' . number_format($transaction->class->price * $transaction->number_of_passengers, 0, ',', '.') }}</p>
                        </div>
                    </div>
        ...
        {{-- RIGHT CONTENT --}}
        <div id="Right-Content" class="flex flex-col gap-[30px] flex-1">
            ...
            @foreach ($transaction->passengers as $passenger)
            <div class="accordion-with-select group flex flex-col h-fit rounded-[20px] bg-white overflow-hidden transition-all duration-300">
                <button type="button" class="accordion-btn flex items-center justify-between p-5">
                    <h2 class="font-bold text-xl leading-[30px]">Passenger {{ $loop->iteration }}</h2>
                    <img src="{{ asset('assets/images/icons/arrow-up-circle-black.svg') }}"
            ...
            <a href="#" class="w-full rounded-full py-3 px-5 text-center bg-garuda-blue hover:shadow-[0px_14px_30px_0px_#0068FF66] transition-all duration-300">
